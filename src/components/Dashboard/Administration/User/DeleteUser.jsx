...
const DeleteUser = (props) => {
    ...
    const DeleteEvent = (id) => {
        // Send id to Users.jsx handleDelete() so that data can be deleted by using current id
        props.DeleteUser(id)
        ...
        <>
            <div className="delete-user-section">
                ...
                <p>This action <strong>cannot</strong> be undone. This will permanently delete the
                    <strong> {props.DeletedData.name}</strong> user, and remove all collaborator associations.</p>
                ...
                <div className="delete-user-btn">
                    {
                        input.username === props.DeletedData.name ? <button className='delete' onClick={() => DeleteEvent(props.DeletedData.id)}>Delete</button> :
                            <button className='delete-disable' disabled >Delete User</button>
