...
const SimulatioinList = [
    ...
    {
        id: 5,
        type: 'Run a Derive By URL Simulation',
        details: 'You have not run any recent simulation using this technique.',
        status: 0
    }
]
    ...
    return (
        <>
            ...
            <div className="simulation-content simulation-recomended" >
                <span className='simulation-content-header'>Smimulation Recomendations</span>
                ...
                SimulatioinList.map((value, index) => {
                    return (
                        <>
                            ...
                            <div className="simulatiion-recomended-header-text" key={value.id}>
